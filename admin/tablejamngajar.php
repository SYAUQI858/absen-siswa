...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi2/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi2/admin/jamngaja" class="current">Jam Ngajar</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
                $query_tampil=mysqli_query($konek,"select * from jam_mengajar");
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensi2/admin/jamngajar/edit/<?PHP echo $data['id_jam_mengajar']?>"class="btn btn-info">Edit</a></td>
                  <td><a href="http://localhost/absensi2/admin/jamngajar/hapus/<?PHP echo $data['id_jam_mengajar']?>"class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
