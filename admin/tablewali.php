...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi2/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi2/admin/wali" class="current">Wali Kelas</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensi2/admin/wali/edit/<?PHP echo $data['id_wali']?>"class="btn btn-info">Edit</a></td>
                  <td><a href="http://localhost/absensi2/admin/wali/hapus/<?PHP echo $data['id_wali']?>"class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
