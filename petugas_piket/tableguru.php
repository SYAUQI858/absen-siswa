...
$keterangan_terlambat=0;
 ...
 if(isset($_GET['carinama'])){
   ...
   $query_tampil=mysqli_query($konek,"select * from guru where nama like '%$cari_nama_guru%' ORDER BY nama");
 }else {
   // query tampil
   $query_tampil=mysqli_query($konek,"SELECT * FROM guru ORDER BY nama ASC");
 }
 //end pencarian data
 ?>
 ...
 <div id="content">
   <div id="content-header">
     <div id="breadcrumb"> <a href="http://localhost/absensi2/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
       <a href="http://localhost/absensi2/petugas_piket/guru" class="tip-bottom">Guru</a><a href="#" class="current">Absen</a> </div>
     <h1>Absen Guru</h1>
   </div>
   <div class="container">
     <div class="span11">
         ...
         <div class="widget-content">
           <form method="get">
             <div class="control-group">
               ...
               <div class="controls">
                 <input type="text"placeholder="Nama"name="carinama" />
               </div>
             </div><br>
             <div class="control-group">
   ...
   <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="table-responsive">
              <form method="post"action="./proses.php?kategori=absen_guru">
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                ...
                <tr>
                  <td><input type="checkbox" name="id_guru[]"value="<?PHP echo $data['id_guru']; ?>"/></td>
                  ...
                  //perulangan kehadiran sesuai tanggal
                  if(isset($_GET['bulan'])){
                      $query_tampil_tanggal=mysqli_query($konek,"SELECT * FROM absen_guru WHERE
                        id_guru=$data[id_guru] and tgl_absen like '%$_GET[tahun]-$cari_bulan_guru%' ORDER BY tgl_absen ASC;");
                  }else{
                    $cari_bulan_guru=date('m');
                    $tahun=date('Y');
                    $query_tampil_tanggal=mysqli_query($konek,"SELECT * FROM absen_guru WHERE id_guru=$data[id_guru]
                    and tgl_absen like '%$tahun-$cari_bulan_guru%' ORDER BY tgl_absen ASC;");
                  }
            ...
            <div class="widget-box">
              ...
              <div class="widget-content">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="date" name="tgl_absen" value="<?PHP echo date('Y-m-d'); ?>">
                    </div>
                  </div>
                  <div class="control-group">
